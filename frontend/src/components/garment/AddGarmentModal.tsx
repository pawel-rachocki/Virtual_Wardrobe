...
const AddGarmentModal = ({ onClose, onSuccess }: Props) => {
            ...
            {previewUrl ? (
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute bottom-3 right-3 text-[10px] uppercase px-3 py-1.5 rounded-sm text-[#1A1A18] hover:bg-[#FAF8F5] transition-colors"
                >
                  Zmień
                </button>
              </div>
              ...
              <button
                type="button"
                onClick={() => fileInputRef.current?.click()}
                style={{ border: '1px dashed #C8C4BE', aspectRatio: '4/3' }}
                className="w-full rounded-sm flex flex-col items-center justify-center gap-3 hover:border-[#C8906A] transition-colors"
              >
                <svg
                  width="28"
                  height="28"
                ...
                <span
                  style={{ letterSpacing: '0.10em', color: '#A09A93' }}
