...
import SavedOutfitsList from '../components/outfit/SavedOutfitsList'
    ...
    <MainLayout>
      ...
      <main className="max-w-5xl mx-auto px-6 sm:px-10 pt-14 sm:pt-20 pb-28 md:pb-20">
        ...
        >
          ...
          {/* Tab switcher */}
          <div className="mt-10 flex gap-8 border-b border-[#E8E4DF]">
            {(['creator', 'saved'] as Tab[]).map((tab) => {
              const label = tab === 'creator' ? 'Kreator' : 'Zapisane outfity'
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: 'none',
                    border: 'none',
                    borderBottom: isActive ? '1.5px solid #1A1A18' : '1.5px solid transparent',
                    cursor: 'pointer',
      ...
      {/* Fixed bottom bar — tylko mobile, tylko w kreatorze */}
      {activeTab === 'creator' && !loading && !error && (
